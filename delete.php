...
<body>
    <h2>delete from stations table</h2>
   <form class="modal-content animate" method="post" action="delete.php">
...
$sql = "DELETE FROM stations WHERE stid='$stid'";

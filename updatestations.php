...
<body>
    ...
    <h2>update in stations table</h2>
   <form class="modal-content animate" method="post" action="updatestations.php">
    

    <div class="container">
      <label for="stid"><b>Enter station id</b></label>
      <input type="text" placeholder="Enter station id" name="stid" required>

      <label for="stname"><b>enter station name</b></label>
...
$sql = "UPDATE stations SET stname='$stname' WHERE stid='$stid'";
